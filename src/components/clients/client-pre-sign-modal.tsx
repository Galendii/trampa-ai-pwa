...
const ClientPreSignModal: React.FC<ClientPreSignModalProps> = ({
  onSuccess,
}) => {
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <div>
        ...
        <p className="text-sm text-slate-600 mt-1">
          Insira os dados básicos do cliente. Ele receberá um convite para
          completar o cadastro e definir uma senha.
        </p>
      </div>
...
export default ClientPreSignModal;
