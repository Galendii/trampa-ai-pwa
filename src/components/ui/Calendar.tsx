...
export function Calendar({
  ...
  maxTime = "22:00",
  timeSlotDuration = 30,
  eventColors = ["#3b82f6", "#ef4444", "#10b981", "#f59e0b", "#8b5cf6", "#ec4899", "#06b6d4", "#84cc16"],
}: CalendarProps) {
    ...
    return (
      <div className="flex-1">
        ...
        <div className="grid grid-cols-7 flex-1">
          {days.map((date, index) => {
            if (!showWeekends && (index % 7 === 5 || index % 7 === 6)) return null
              ...
              >
                ...
                <div className="flex-1 space-y-0.5 sm:space-y-1 overflow-hidden">
                        ...
                        {!event.allDay && (
                          <div className="text-xs opacity-75 mt-0.5 leading-tight">
                            ...
                            {window.innerWidth >= 640 &&
                              event.endDate.toTimeString().slice(0, 5) !== event.startDate.toTimeString().slice(0, 5) &&
                  ...
                  {dayEvents.length > (window.innerWidth < 640 ? 2 : 4) && (
                    ...
                    >
                      +{dayEvents.length - (window.innerWidth < 640 ? 2 : 4)} mais
                    </div>
                  )}
                </div>
              </div>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex border-b border-slate-200">
          ...
          {weekDays.map((date) => {
            const isToday = date.toDateString() === new Date().toDateString()
            return (
              <div key={date.toISOString()} className="flex-1 p-2 sm:p-3 text-center border-r border-slate-200">
                <div className="text-xs sm:text-sm text-slate-600">
                  <span className="hidden sm:inline">{date.toLocaleDateString("pt-BR", { weekday: "short" })}</span>
  ...
  const renderDayView = () => {
    const allDayEvents = events.filter(
      (event) => event.allDay && event.startDate.toDateString() === currentDate.toDateString(),
    )
      ...
      <div className="flex-1 flex flex-col">
        ...
        {allDayEvents.length > 0 && (
          <div className="border-b border-slate-200 p-3">
            <div className="text-sm font-medium text-slate-600 mb-2">Dia inteiro</div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-slate-600 space-y-1">
                      <div className="flex items-center">
                        ...
                        {event.allDay
                          ? "Dia inteiro"
                          : `${event.startDate.toTimeString().slice(0, 5)} - ${event.endDate.toTimeString().slice(0, 5)}`}
                      </div>
  ...
  return (
    <div className={cn("flex flex-col h-full bg-white border border-slate-200 rounded-lg", className)}>
      ...
      <div className="flex flex-col space-y-3 sm:space-y-0 sm:flex-row sm:items-center justify-between p-3 sm:p-4 border-b border-slate-200">
        ...
        <div className="flex items-center space-x-2 w-full sm:w-auto">
            ...
            {(["month", "week", "day", "agenda"] as CalendarView[]).map((viewType) => (
              <button
                ...
                className={cn(
                  ...
                  view === viewType ? "bg-white text-slate-900 shadow-sm" : "text-slate-600 hover:text-slate-900",
                )}
              >
                {viewType === "month" && (
                  <>
          ...
          <Button onClick={() => handleCreateEvent()} size="sm" className="flex-shrink-0 h-8 sm:h-10">
      ...
      >
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <DatePicker
                ...
                onChange={(date) => date && setEventForm({ ...eventForm, startDate: date })}
              />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <DatePicker
                ...
                onChange={(date) => date && setEventForm({ ...eventForm, endDate: date })}
              />
                  ...
                  {eventColors.map((color) => (
                    <button
                      ...
                      className={cn(
                        ...
                        eventForm.color === color ? "border-slate-400 scale-110" : "border-slate-200",
                      )}
        ...
        <ModalFooter>
          ...
          <Button onClick={handleSubmitEvent} disabled={!eventForm.title.trim()}>
