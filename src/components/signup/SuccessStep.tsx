...
export default function SuccessStep({ userName }: SuccessStepProps) {
  return (
    <div className="text-center py-8">
      ...
      <h3 className="text-2xl font-bold text-slate-800 mb-4">Conta criada com sucesso!</h3>
      <p className="text-slate-600 mb-6">
        Bem-vindo ao Trampa AI, <strong>{userName}</strong>! Você será redirecionado para o dashboard em instantes.
      </p>
